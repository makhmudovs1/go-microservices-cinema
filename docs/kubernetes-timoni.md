...
The bundle `cinema` is an [OCI artifact](https://timoni.sh/bundle-distribution/) that describes the cinema deployment.

```
timoni artifact pull oci://registry.example.com/cinema/bundles/cinema
```
...
<details>
  ...
  bundle: {
          ...
          instances: {
                  website: {
                          module: url:     "oci://registry.example.com/cinema/modules/website"
                  ...
                  bookings: {
                          module: url:     "oci://registry.example.com/cinema/modules/api"
                          module: version: "0.2.0"
                          namespace: "default"
                          values: args: [
                                  "-mongoURI",
                  ...
                  users: {
                          ...
                          values: image: {
                                  repository: "cinema-users"
                                  digest:     "sha256:3a1e8fd1f3cb832981bcadb3fff056eb0a2300cf7cb6bf94460c6bccdd6743ed"
                                  tag:        "v2.2.2"
                          }
                  }
                  mongodb: {
                          module: url:     "oci://registry.example.com/cinema/modules/mongodb"
                          module: version: "0.2.0"
                          namespace: "default"
                  }
          }
...
All instances make reference to OCI artifacts stored in a container registry.
...
bookings        oci://registry.example.com/cinema/modules/api      0.2.0   2023-12-03T18:01:07Z    cinema
mongodb         oci://registry.example.com/cinema/modules/mongodb  0.2.0   2023-12-03T18:01:12Z    cinema
movies          oci://registry.example.com/cinema/modules/api      0.2.0   2023-12-03T18:00:56Z    cinema
showtimes       oci://registry.example.com/cinema/modules/api      0.2.0   2023-12-03T18:01:01Z    cinema
users           oci://registry.example.com/cinema/modules/api      0.2.0   2023-12-03T18:00:50Z    cinema
website         oci://registry.example.com/cinema/modules/website  0.2.0   2023-12-03T18:00:45Z    cinema
```
